...
insert into main_identitycodes (id,employee_code,backgroundagency_code, vendors_code, staffing_code, users_code, requisition_code, createdBy, createddate, modifiedBy, modifieddate)values(1, 'EMPP', 'BGCK', '', '', 'USER', 'REQ', '1', now(), '1', now());
...
insert  into `main_patches_version`(`version`,`createddate`,`modifieddate`,`isactive`) values ('1.1.7',now(),now(),1);
