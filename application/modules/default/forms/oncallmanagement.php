...
class Default_Form_oncallmanagement extends Zend_Form
{
	public function init()
	{
		...
		$department_id->setAttrib("onchange", "gethrmanagersoncall(this);");
		...
		$submit->setLabel('Save');
		 ...
		 $this->addElements(array($id,$startmonth,$weekend_startday,$weekend_endday,$businessunit,$department_id,$hours_day,$halfday,$skipholidays,$oncalltransfer,$description,$hrmanager,$submit));
