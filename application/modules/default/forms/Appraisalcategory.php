...
class Default_Form_Appraisalcategory extends Zend_Form
{
	public function init()
	{
		...
		$appraisalcategory->setLabel("Category");
        ...
        $appraisalcategory->addValidator('NotEmpty', false, array('messages' => 'Please enter category.'));
		...
		$appraisalcategory->getValidator('Db_NoRecordExists')->setMessage('Category name already exists.');	
