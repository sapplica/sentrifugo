...
protected function _getAcl()
{
	...
	if(!isset($role))
		 ...
		 $acl->addResource(new Zend_Acl_Resource('timemanagement:reports'));
									$acl->allow($tmroleText[$role], 'timemanagement:reports', array('index','employeereports','billingreport','projectsreports','getempduration','getprojecttaskduration','tmreport','billingreport'));
