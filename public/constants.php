...
defined('APPROVEDONCALLS_DELETE')|| define('APPROVEDONCALLS_DELETE', 'oncall');
...
defined('CANCELONCALLS_DELETE')|| define('CANCELONCALLS_DELETE',   'cancelled oncall');
...
defined('EMPONCALLS_DELETE')|| define('EMPONCALLS_DELETE', 'oncall details');
...
defined('EMPONCALLSUMMARY_DELETE')|| define('EMPONCALLSUMMARY_DELETE', 'oncall');
...
defined('ONCALLMANAGEMENT_DELETE')|| define('ONCALLMANAGEMENT_DELETE', 'oncall management');
defined('ONCALLREQUEST_DELETE')|| define('ONCALLREQUEST_DELETE',   'oncall request');
defined('EMPLOYEEONCALLTYPES_DELETE')|| define('EMPLOYEEONCALLTYPES_DELETE',   'oncall type');
...
defined('PENDINGONCALLS_DELETE')|| define('PENDINGONCALLS_DELETE', 'pending oncall');
...
defined('REJECTEDONCALLS_DELETE')|| define('REJECTEDONCALLS_DELETE','rejected oncall');
