...
(function ($, undefined) {
    ...
    function markMatch(text, term, markup, escapeMarkup) {
        ...
        //markup.push(escapeMarkup(text.substring(match, match + tl)));/*updated by Ravi*/
        markup.push("</span>");
        //markup.push(escapeMarkup(text.substring(match + tl, text.length)));/*updated by Ravi*/
        markup.push(escapeMarkup(text.substring(match, text.length)));/*updated by Ravi*/
    }
    ...
    AbstractSelect2 = clazz(Object, {
        ...
        init: function (opts) {
            ...
            search.bind("blur", function () { search.removeClass("select2-focused");
                //below is added by k.rama krishna
                $("#"+container_id).trigger('blur');
                    ...
                    populate=function(results, container, depth) {
                        ...
                        for (i = 0, l = results.length; i < l; i = i + 1) {
                            ...
                            if (formatted!==undefined) {
                                ...
                                if(formatted.indexOf("<img") > -1)
                                {
                                    //console.log(formatted);
                                    label.addClass('img-div-height');
                                }//the above if is added by k.rama krishna on 18-nov-2013
                            }
    ...
    SingleSelect2 = clazz(AbstractSelect2, {
        ...
        onSelect: function (data, options) {
            ...
            //below is added by rama krishna on 15-oct-2013
            $('#'+this.container.prop('id')).trigger('blur');
    ...
    MultiSelect2 = clazz(AbstractSelect2, {
        ...
        initContainer: function () {
            ...
            this.search.bind("blur", this.bind(function(e) {
                //below is added by k.rama krishna on 07-oct-2013 for multiselection
                $('#'+this.container.prop('id')).trigger('blur');
                this.container.removeClass("select2-container-active");
        ...
        // multi
        onSelect: function (data, options) {
            if(this.id(data) != '' && this.id(data) != null)// added by rama krishna 04-nov-2013
            {
            ...
            //below added by rama krishna on 16-oct-2013
            $('#'+this.container.prop('id')).trigger('blur');
            if (!options || !options.noFocus)
                this.focusSearch();
            }
		 ...
		 sortResults: function(results, container, query) {
			if (query.term) {
				...
				return results.sort(function(a, b) {
					...
					//To sort results based on First occurance
