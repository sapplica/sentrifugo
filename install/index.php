...
<head>
    ...
    <link href='http://fonts.googleapis.com/css?family=Lato:400,700,400italic,300,300italic,100italic,100,700italic,900,900italic'
    ...
    <script language="JavaScript" type="text/javascript" src="../public/media/jquery/js/select2.js"></script>
    <!-- added on 07-aug-2013 by rama krishna -->
...
<div class="container">
    ...
    <div class="left_steps">
        ...
        <ul class="steps_ul">
            ...
            <li class="fifth_li">
                <h4>LDAP Server Settings</h4>
                <div class="fifth_icon icon"></div>
                <span>Confirm your LDAP server if you have one</span>
            </li>
            <li class="sixth_li">
                <h4>Final Check</h4>
                <div class="fifth_icon icon"></div>
