...
insert into main_identitycodes (id,employee_code,backgroundagency_code, vendors_code, staffing_code, users_code, requisition_code, createdBy, createddate, modifiedBy, modifieddate)values('id', 'EMPP', 'BGCK', '', '', 'USER', 'REQ', '1', '2015-03-05 11:46:44', '1', '2015-03-05 11:46:44');
...
insert  into `main_patches_version`(`version`,`createddate`,`modifieddate`,`isactive`) values ('1.1.6',now(),now(),1);
