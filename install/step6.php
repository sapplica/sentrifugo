        ...
        <div class="content_part">
                ...
                <ul class="progress">
                    ...
                    <div>
                        ...
                        foreach ($req_html_arr as $req => $req_value) {
                            ?>
                            <li><?php echo $req_value; ?>
                                <div class="status_yes"></div>
                            </li>
                            <?php
                        }
                        ?>
                    ...
                    <div>
                        <li><span class="info">Host:</span><span class="infotext"><?php echo SENTRIFUGO_HOST; ?></span>
                        </li>
                        <li><span class="info">Username:</span><span
                                    class="infotext"><?php echo SENTRIFUGO_USERNAME; ?></span></li>
                        <li><span class="info">Password:</span><span
                                    class="infotext"><?php echo SENTRIFUGO_PASSWORD; ?></span></li>
                        <li><span class="info">Database:</span><span
                                    class="infotext"><?php echo SENTRIFUGO_DBNAME; ?></span></li>
                    </div>

                    <li class="accclass"><h4>Application Settings<span class="iteminfo">(2 items)</span></h4></li>
                    <div>
                        <li><span class="info">Application name:</span><span
                                    class="infotext"><?php echo APPLICATION_NAME; ?></span></li>
                        <li><span class="info">Email:</span><span
                                    class="infotext"><?php echo SUPERADMIN_EMAIL; ?></span></li>
                    </div>

                    <li class="accclass"><h4>Mail Server Settings<span class="iteminfo">(6 items)</span></h4></li>
                    <div>
                        <li><span class="info">Authentication:</span><span
                                    class="infotext"><?php echo MAIL_AUTH; ?></span></li>
                        <li><span class="info">Username:</span><span
                                    class="infotext"><?php echo MAIL_USERNAME; ?></span></li>
                        <li><span class="info">Password:</span><span
                                    class="infotext"><?php echo MAIL_PASSWORD; ?></span></li>
                        <li><span class="info">SMTP server:</span><span class="infotext"><?php echo MAIL_SMTP; ?></span>
                        </li>
            ...
            <div id="mailcontentdiv" style="display: none;">
                <ul style="list-style: none outside none; width: 100%; background: none repeat scroll 0% 0% rgb(255, 255, 255); padding: 0px;">
                    <li style="border-bottom: 1px solid rgb(204, 204, 204); margin: 0px; padding: 10px 5px 10px 15px;">
                        <h4 style="color: rgb(105, 145, 61); margin-top: 8px; margin-bottom: 0px;">Pre-requisites</h4>
                    </li>
                    <div>
                        <?php
                        ...
                        foreach ($req_html_arr as $req => $req_value) {
                            ?>
                            <li style="border-bottom: 1px solid rgb(204, 204, 204); margin: 0px; padding: 10px 5px 10px 15px;"><?php echo $req_value; ?>
                                <div class="status_yes"></div>
                            </li>
                            <?php
                        }
                    ...
                    ?>
                    <li style="border-bottom: 1px solid rgb(204, 204, 204); margin: 0px; padding: 10px 5px 10px 15px;">
                        <h4 style="color: rgb(105, 145, 61); margin-top: 8px; margin-bottom: 0px;">Database
                            Settings</h4></li>
                    <div>
                        <li style="border-bottom: 1px solid rgb(204, 204, 204); margin: 0px; padding: 10px 5px 10px 15px;">
                            <span>Host: </span><span><?php echo SENTRIFUGO_HOST; ?></span></li>
                        <li style="border-bottom: 1px solid rgb(204, 204, 204); margin: 0px; padding: 10px 5px 10px 15px;">
                            <span>User name: </span><span><?php echo SENTRIFUGO_USERNAME; ?></span></li>
                        <li style="border-bottom: 1px solid rgb(204, 204, 204); margin: 0px; padding: 10px 5px 10px 15px;">
                            <span>Password: </span><span><?php echo $password; ?></span></li>
                        <li style="border-bottom: 1px solid rgb(204, 204, 204); margin: 0px; padding: 10px 5px 10px 15px;">
                            <span>Database: </span><span><?php echo SENTRIFUGO_DBNAME; ?></span></li>
                    </div>

                    <li style="border-bottom: 1px solid rgb(204, 204, 204); margin: 0px; padding: 10px 5px 10px 15px;">
                        <h4 style="color: rgb(105, 145, 61); margin-top: 8px; margin-bottom: 0px;">Application
                            Settings</h4></li>
                    <div>
                        <li style="border-bottom: 1px solid rgb(204, 204, 204); margin: 0px; padding: 10px 5px 10px 15px;">
                            <span>Application name: </span><span><?php echo APPLICATION_NAME; ?></span></li>
                        <li style="border-bottom: 1px solid rgb(204, 204, 204); margin: 0px; padding: 10px 5px 10px 15px;">
                            <span>Email: </span><span><?php echo SUPERADMIN_EMAIL; ?></span></li>
                    </div>

                    <li style="border-bottom: 1px solid rgb(204, 204, 204); margin: 0px; padding: 10px 5px 10px 15px;">
                        <h4 style="color: rgb(105, 145, 61); margin-top: 8px; margin-bottom: 0px;">Mail Server
                            Settings</h4></li>
                    <div>
                        <li style="border-bottom: 1px solid rgb(204, 204, 204); margin: 0px; padding: 10px 5px 10px 15px;">
                            <span>Authentication: </span><span><?php echo MAIL_AUTH; ?></span></li>
                        <li style="border-bottom: 1px solid rgb(204, 204, 204); margin: 0px; padding: 10px 5px 10px 15px;">
                            <span>User name: </span><span><?php echo MAIL_USERNAME; ?></span></li>
                        <li style="border-bottom: 1px solid rgb(204, 204, 204); margin: 0px; padding: 10px 5px 10px 15px;">
                            <span>Password: </span><span><?php echo MAIL_PASSWORD; ?></span></li>
                        <li style="border-bottom: 1px solid rgb(204, 204, 204); margin: 0px; padding: 10px 5px 10px 15px;">
                            <span>SMTP server: </span><span><?php echo MAIL_SMTP; ?></span></li>
                        <li style="border-bottom: 1px solid rgb(204, 204, 204); margin: 0px; padding: 10px 5px 10px 15px;">
                            <span>Secure Transport Layer: </span><span><?php echo MAIL_TLS; ?></span></li>
                        <li style="border-bottom: 1px solid rgb(204, 204, 204); margin: 0px; padding: 10px 5px 10px 15px;">
                            <span>Port: </span><span><?php echo MAIL_PORT; ?></span></li>
                    </div>

                    <li style="border-bottom: 1px solid rgb(204, 204, 204); margin: 0px; padding: 10px 5px 10px 15px;">
                        <h4 style="color: rgb(105, 145, 61); margin-top: 8px; margin-bottom: 0px;">Cron Job</h4></li>
                    <div>
            ...
            <input type="hidden" id="cronjoburl" name="cronjoburl"
                   value="<?php echo str_replace("install/", "", BASE_URL . 'cronjob'); ?>"/>
            <input type="hidden" id="expirydocurl" name="expirydocurl"
                   value="<?php echo str_replace("install/", "", BASE_URL) . 'cronjob/empdocsexpiry'; ?>"/>
            <input type="hidden" id="tmcronurl" name="tmcronurl"
                   value="<?php echo str_replace("install/", "", BASE_URL) . 'timemanagement/cronjob'; ?>"/>
            ...
            <button name="previous" id="previous" type="button" class="previous_button"
                    onclick="window.location='index.php?s=<?php echo sapp_Global::_encrypt(5); ?>';">Previous
            </button>
    </form>
